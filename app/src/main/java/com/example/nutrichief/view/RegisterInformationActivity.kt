...
//                                            if (response.isSuccessful) {
//                                                val loginIntent =
//                                                    Intent(this@RegisterInformationActivity, MainActivity::class.java)
//                                                val sharedPrefs =
...
//                                        Toast.makeText(this@RegisterInformationActivity, "Failed to retrieve user profile", Toast.LENGTH_SHORT).show()
